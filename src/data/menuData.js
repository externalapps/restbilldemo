...
export const quotationPlans = [
  {
    ...
    hardware: [
      ...
      'Barcode Scanner (₹3,500) - USB barcode scanner',
      'Cash Drawer (₹2,500) - Electronic cash drawer'
    ],
    hardwareTotal: '₹39,000',
  ...
  },
  {
    ...
    hardware: [
      ...
      'Barcode Scanner (₹5,000) - Wireless barcode scanner',
      'Cash Drawer (₹3,500) - Heavy-duty electronic cash drawer',
      'Customer Display (₹8,000) - 2-line customer display screen',
      'Receipt Paper (₹2,000) - Thermal paper rolls (1 year supply)'
    ],
    hardwareTotal: '₹65,500',
